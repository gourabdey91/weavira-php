...
<footer class="site-footer">
    ...
    <div class="wv-footer-follow">
        ...
        <div class="wv-footer-follow-list">
            @if($footer_left_social_media['footer_instagram_link'])
            <a href="{{ $footer_left_social_media['footer_instagram_link'] }}" class="wv-footer-follow-item" aria-label="Instagram">
                <span class="wv-footer-follow-icon"><i data-lucide="instagram" aria-hidden="true"></i></span>
                <span>Instagram</span>
            </a>
            @endif
            @if($footer_left_social_media['footer_linkedin_link'])
            <a href="{{ $footer_left_social_media['footer_linkedin_link'] }}" class="wv-footer-follow-item" aria-label="Pinterest">
            ...
            @endif
            @if($footer_left_social_media['footer_yt_link'])
            <a href="{{ $footer_left_social_media['footer_yt_link'] }}" class="wv-footer-follow-item" aria-label="YouTube">
                <span class="wv-footer-follow-icon"><i data-lucide="youtube" aria-hidden="true"></i></span>
                <span>YouTube</span>
            </a>
            @endif
            @if($footer_left_social_media['footer_facebook_link'])
            <a href="{{ $footer_left_social_media['footer_facebook_link'] }}" class="wv-footer-follow-item" aria-label="Facebook">
    ...
    <div class="wv-footer-values">
        <div class="wv-footer-value-col">
            ...
            <p class="footer-brand-desc">{!! get_field('footer_content_content', 'options') !!}</p>
            @if(get_field('about_cta_link', 'options'))
            <a class="wv-card-explore" href="{{ get_field('about_cta_link', 'options')['url'] }}">{{ get_field('about_cta_link', 'options')['title'] }} &#8594;</a>
            @endif
        </div>
        <div class="wv-footer-value-col">
            <div class="wv-footer-value-head">
    ...
    @if(get_field('ffbi_featured_image', 'options'))
    <img src="{!! get_field('ffbi_featured_image', 'options')['url'] !!}" alt="{!! get_field('ffbi_featured_image', 'options')['alt'] !!}" class="wv-footer-design-row" aria-hidden="true"
        loading="lazy">
    @endif

    <!-- Bottom bar -->
    <div class="footer-bottom">
        <p class="footer-copy">&copy; {{ date('Y') }} {{ get_bloginfo('name') }}. All Rights Reserved. {!! \App\Support\FooterCredit::render() !!}
                </p>
