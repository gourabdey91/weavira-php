@php $logo = get_field('arc_option_logo', 'option'); @endphp

<section class="wv-jnl-signoff">
  <div class="wv-jnl-signoff-brand">
    <div class="wv-jnl-signoff-seal">
      @if($logo)
        <span class="wv-jnl-signoff-mark" aria-hidden="true"><img src="{{ $logo }}" alt=""></span>
      @endif
  ...
  <div class="wv-jnl-signoff-body">
    @if(!empty($section['signoff_message']))
      <p class="wv-jnl-signoff-message">{{ $section['signoff_message'] }}</p>
    @endif
