<div class="myaccount-welcome">
  <p>Hello, <strong>{{ $current_user->display_name }}</strong> <span class="myaccount-welcome-sub">(not you? <a href="{{ wc_logout_url() }}">Log out</a>)</span></p>
  <p class="myaccount-welcome-desc">From your account dashboard you can view your <a href="{{ wc_get_endpoint_url('orders') }}">recent orders</a>, manage your <a href="{{ wc_get_endpoint_url('edit-address') }}">billing address</a>, and <a href="{{ wc_get_endpoint_url('edit-account') }}">edit your password and account details</a>.</p>
</div>

<div class="myaccount-quick-links">
  <a href="{{ wc_get_endpoint_url('orders') }}" class="myaccount-quick-link">
  ...
  <a href="{{ wc_get_endpoint_url('edit-address') }}" class="myaccount-quick-link">
  ...
  <a href="{{ wc_get_endpoint_url('edit-account') }}" class="myaccount-quick-link">
  ...
  <a href="{{ wc_get_page_permalink('shop') }}" class="myaccount-quick-link">
...
@if(!empty($recentOrder))
  <div class="myaccount-recent-order">
    <div class="myaccount-recent-order-head">
      ...
      <a href="{{ $recentOrder['viewUrl'] }}" class="myaccount-recent-order-view">View Order &#8594;</a>
    </div>
    ...
    <div class="myaccount-recent-order-row">
      <span>Status</span>
      <strong class="myaccount-order-status myaccount-order-status--{{ $recentOrder['statusSlug'] }}">{{ $recentOrder['status'] }}</strong>
    </div>
    <div class="myaccount-recent-order-row">
      <span>Total</span>
      <strong>{!! $recentOrder['total'] !!}</strong>
    </div>
  </div>
@endif
