...
class GoogleGAL_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'classes' => array(
        ...
        'GoogleGAL_Service_Exception' => array(
          'retry_map' => array(
   ...
   * the hd values within an id token (@see GoogleGAL_Auth_LoginTicket) after sign
