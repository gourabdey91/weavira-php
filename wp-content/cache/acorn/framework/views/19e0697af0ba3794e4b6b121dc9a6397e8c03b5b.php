<form class="woocommerce-EditAccountForm edit-account myaccount-account-form" action="" method="post">
  ...
  <div class="ck-field-grid myaccount-field-grid">
    <p class="form-row form-row-first">
      ...
      <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name" autocomplete="given-name" value="<?php echo e(esc_attr($user->first_name)); ?>" />
    </p>
    <p class="form-row form-row-last">
      <label for="account_last_name">Last name <span class="required" aria-hidden="true">*</span></label>
      <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_last_name" id="account_last_name" autocomplete="family-name" value="<?php echo e(esc_attr($user->last_name)); ?>" />
    </p>
    <p class="form-row form-row-wide">
      <label for="account_display_name">Display name <span class="required" aria-hidden="true">*</span></label>
      <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo e(esc_attr($user->display_name)); ?>" />
    ...
    <p class="form-row form-row-wide">
      ...
      <input type="email" class="woocommerce-Input woocommerce-Input--email input-text" name="account_email" id="account_email" autocomplete="email" value="<?php echo e(esc_attr($user->user_email)); ?>" />
    </p>
  </div>
...
<?php /**PATH /home/u908449413/domains/weavira.com/public_html/wp-content/themes/weavira/resources/views/woocommerce/myaccount/edit-account.blade.php ENDPATH**/ ?>